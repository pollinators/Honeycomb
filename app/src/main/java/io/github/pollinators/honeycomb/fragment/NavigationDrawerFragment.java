 ...
 */
public class NavigationDrawerFragment extends PollinatorsBaseFragment {
    ...
    public int getContentViewId() {
        return R.layout.frag_nav_drawer;
    }

    @Override
    public void onActivityCreated (Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        // Indicate that this pollinators.github.io.pollinatorresearchcollector.fragment would like to influence the set of actions in the action bar.
    ...
    /**
     * Users of this pollinators.github.io.pollinatorresearchcollector.fragment must call this method to set up the navigation drawer interactions.
     *
     * @param fragmentId   The android:id of this pollinators.github.io.pollinatorresearchcollector.fragment in its activity's layout.
     * @param drawerLayout The DrawerLayout containing this pollinators.github.io.pollinatorresearchcollector.fragment's UI.
     */
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                if (!mUserLearnedDrawer) {
                    ...
                    sharedPreferences.edit().putBoolean(PREF_USER_LEARNED_DRAWER, true).commit();
                }
